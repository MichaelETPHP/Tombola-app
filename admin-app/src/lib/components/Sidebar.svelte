<script lang="ts">
  ...
  import { AlertTriangle, Bug, ChartNoAxesCombined, ChevronDown, Contact, FileClock, Image, LogOut, Menu, MessageSquareText, PackageCheck, Plug, Settings, ShieldCheck, Ticket, Users, X } from 'lucide-svelte';
