...
await i18next.init({
  ...
  resources: {
    en: { translation: {
      ...
      'raffle.salesDisabled': 'Ticket sales are currently inactive for this raffle.',
      'raffle.demoNotPurchasable': 'This is a sample raffle. Ticket purchases are not available.',
      'raffle.salesUnavailable': 'Raffle sales settings are temporarily unavailable. Please contact the platform administrator.',
      'raffle.imageRequired': 'Choose an image file to upload.',
      'raffle.invalidImage': 'That file could not be read as an image.',
      'raffle.imageTooLarge': 'Image is too large (max 8MB).',
    ...
    am: { translation: {
      ...
      'raffle.imageRequired': 'የሚሰቀል ምስል ፋይል ይምረጡ።',
      'raffle.invalidImage': 'ያ ፋይል እንደ ምስል ሊነበብ አልቻለም።',
      'raffle.imageTooLarge': 'ምስሉ በጣም ትልቅ ነው (ከፍተኛ 8MB)።',
      'room.notAMember': 'ይህን ክፍል ለመቀላቀል ለዚህ ዕጣ ትኬት ይግዙ።',
      'room.readOnly': 'ይህ ዕጣ አልቋል — ክፍሉ አሁን ለንባብ ብቻ ነው።',
      'admin.phoneTaken': 'ያ ስልክ ቁጥር አስቀድሞ አስተዳዳሪ ነው።',
      'admin.cannotDeleteSelf': 'የራስዎን የአስተዳዳሪ መለያ መሰረዝ አይችሉም።',
      'admin.lastOwnerDemote': 'የመጨረሻውን ባለቤት ማውረድ አይቻልም።',
      'admin.lastOwnerDelete': 'የመጨረሻውን ባለቤት መሰረዝ አይቻልም።',
