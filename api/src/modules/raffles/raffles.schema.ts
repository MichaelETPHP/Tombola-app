...
export const assignDrawRepresentativeSchema = z.object({
  tier: z.coerce.number().int().positive(),
  userId: z.string().uuid(),
  reason: z.string().trim().min(3).max(500).default('Representative assigned by Platform Owner'),
});
